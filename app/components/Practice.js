        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {data.practiceAreas.map((a, i) => (
            ...
            >
              {/* Icon Container */}
              <div
                className={`w-14 h-14 rounded-2xl flex items-center justify-center text-[1.45rem] mb-7 transition-all duration-350 group-hover:scale-110 border ${
                  isLight
              ...
              {/* Title & Desc (No gold font, darker text colors in light mode) */}
